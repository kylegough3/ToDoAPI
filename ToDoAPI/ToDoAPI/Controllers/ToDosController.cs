//Step 06. Controller is scaffolded by Entity Framework. Need to cusomize the logic in the Controller endpoints to fetch the category
...
namespace ToDoAPI.Controllers
{
    ...
    public class ToDosController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<ToDo>>> GetToDos()
        {
          ...
          //Step 07. Modify GET functionality to include Categories 
